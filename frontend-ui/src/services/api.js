// frontend-ui/src/services/api.js  v6
...
// ── Browser-based capture — sends raw features, backend scores them ──
export const submitFeatures = (body) => req("POST", "/submit-features", body);

// ── Legacy submit (kept for backward compat / local Python monitoring) ──
...
// ── Local Python monitoring (kept for local dev/testing) ──────────
...
// ── Settings ──────────────────────────────────────────────────────
export const updateProfile   = (body) => req("PUT",    "/update-profile",  body);
export const changePassword  = (body) => req("PUT",    "/change-password", body);
export const deleteAllMyData = ()     => req("DELETE", "/delete-all-my-data");
